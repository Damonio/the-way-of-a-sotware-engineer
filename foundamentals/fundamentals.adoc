...
The main idea behind "The way of the software engineer" is to provide a general guide along all the steps of a software engineer carer. As a software engineer I have felt a couple of times in my career that the software engineer path is unclear and a constant feeling of walking in a direction that it doesn't seem to be where I want to be.
