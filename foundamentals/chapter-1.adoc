...
Software in certain sense is the same, is a series of instructions well-defined that will be executed in the order specified and will produce the same output given that the same input it's given
